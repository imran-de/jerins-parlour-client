...
import { Button, Card, CardContent, Container, Grid, Rating, Typography } from '@mui/material';
import { Box } from '@mui/system';
import icon1 from '../../../Images/Image/Ellipse 90.png';
import icon2 from '../../../Images/Image/Ellipse 91.png';
import icon3 from '../../../Images/Image/Ellipse 92.png';
    ...
    return (
        <Container sx={{ textAlign: 'center' }}>
            ...
            <Link to="/reviews" style={{ textDecoration: 'none' }}>
                <Button sx={{ backgroundColor: '#F63E7B', color: '#fff', px: 4 }} variant='contained'>See more</Button>
            </Link>
        </Container>
    );
};
